...
contract BlogHubSessionKeyTest is BaseTest {
    ...
    function test_EvaluateWithSessionKey_ZeroAmount() public {
        ...
        blogHub.evaluateWithSessionKey(user1, sessionKey, articleId, 1, comment, address(0), 0, deadline, signature);
    }
    ...
    function test_CollectWithSessionKey_Success() public {
        ...
        bytes memory callData = abi.encodeWithSelector(BlogHub.collect.selector, articleId, address(0));
        ...
        vm.expectEmit(true, true, false, true);
        emit ArticleCollected(articleId, user1, amount, articleId + blogHub.COLLECTOR_TOKEN_OFFSET());

        vm.expectEmit(true, true, false, true);
        emit SessionKeyOperationExecuted(user1, sessionKey, BlogHub.collect.selector);

        vm.prank(owner);
        blogHub.collectWithSessionKey{value: amount}(user1, sessionKey, articleId, address(0), deadline, signature);

        // 验证: Collect 应该铸造 NFT (收藏者 tokenId = articleId + COLLECTOR_TOKEN_OFFSET)
        assertEq(blogHub.balanceOf(user1, articleId + blogHub.COLLECTOR_TOKEN_OFFSET()), 1);
    }
    ...
    function test_FollowWithSessionKey_Success() public {
        ...
        bytes memory callData = abi.encodeWithSelector(BlogHub.follow.selector, user2, true);
        ...
        blogHub.followWithSessionKey(user1, sessionKey, user2, true, deadline, signature);
    }

    function test_UnfollowWithSessionKey_Success() public {
        uint256 deadline = block.timestamp + 1 hours;

        bytes memory callData = abi.encodeWithSelector(BlogHub.follow.selector, user2, false);
        ...
        blogHub.followWithSessionKey(user1, sessionKey, user2, false, deadline, signature);
    }
    ...
    function test_FollowWithSessionKey_RevertSessionKeyManagerNotSet() public {
        ...
        vm.prank(user1);
        vm.expectRevert(BlogHub.SessionKeyManagerNotSet.selector);
        blogHubNoManager.followWithSessionKey(user1, sessionKey, user2, true, block.timestamp + 1 hours, "");
    }
    ...
    function test_PublishWithSessionKey_Success() public {
        ...
        bytes memory callData = abi.encodeWithSelector(BlogHub.publish.selector, params);
        ...
        uint256 articleId = blogHub.publishWithSessionKey(user1, sessionKey, params, deadline, signature);
        ...
        assertEq(uint(storedVisibility), uint(params.visibility));
    }
    ...
    function test_PublishWithSessionKey_RevertOriginalAuthorTooLong() public {
        ...
        blogHub.publishWithSessionKey(user1, sessionKey, params, deadline, signature);
    }
    ...
    function test_PublishWithSessionKey_RevertSessionKeyManagerNotSet() public {
        ...
        vm.expectRevert(BlogHub.SessionKeyManagerNotSet.selector);
        blogHubNoManager.publishWithSessionKey(user1, sessionKey, params, block.timestamp + 1 hours, "");
    }
    ...
    function test_PublishWithSessionKey_RevertInvalidSignature() public {
        ...
        blogHub.publishWithSessionKey(user1, sessionKey, params, deadline, invalidSignature);
    }
    ...
    function test_PublishWithSessionKey_MultipleArticles() public {
        ...
        bytes memory callData1 = abi.encodeWithSelector(BlogHub.publish.selector, params1);
        ...
        uint256 articleId1 = blogHub.publishWithSessionKey(user1, sessionKey, params1, deadline, signature1);
        ...
        bytes memory callData2 = abi.encodeWithSelector(BlogHub.publish.selector, params2);
        ...
        uint256 articleId2 = blogHub.publishWithSessionKey(user1, sessionKey, params2, deadline, signature2);
    ...
    function test_MultipleSessionKeyOperations() public {
        ...
        bytes memory callData2 = abi.encodeWithSelector(BlogHub.follow.selector, user2, true);
        ...
        vm.prank(owner);
        blogHub.followWithSessionKey(user1, sessionKey, user2, true, deadline, signature2);
    ...
    function test_Collect_PaymentWithReferrer_SameAsDirect() public {
        ...
        (, , , , , uint96 collectPrice0, uint16 maxSupply0, uint16 collectCount0, ) = blogHub.articles(articleId);
        ...
        (, , , , , , , uint16 collectCount1, ) = blogHub.articles(articleId);
        ...
        uint256 deadline = block.timestamp + 1 hours;
        bytes memory callData = abi.encodeWithSelector(BlogHub.collect.selector, articleId, referrer);
        ...
        vm.prank(owner);
        blogHub.collectWithSessionKey{value: amount}(user1, sessionKey, articleId, referrer, deadline, signature);
    ...
    function test_Collect_MaxSupplyReached_SameAsDirect() public {
        ...
        vm.prank(owner);
        blogHub.collectWithSessionKey{value: amount}(user1, sessionKey, articleId, address(0), deadline, signature1);
        ...
        vm.prank(owner);
        vm.expectRevert(BlogHub.MaxSupplyReached.selector);
        blogHub.collectWithSessionKey{value: amount}(user1, sessionKey, articleId, address(0), deadline, signature2);
    }
