...
export const functions = {
    ...
    publish: fun("0xc7e76bf0", "publish(string,uint64,uint96,string,string)", {"_arweaveId": p.string, "_categoryId": p.uint64, "_royaltyBps": p.uint96, "_originalAuthor": p.string, "_title": p.string}, p.uint256),
    publishWithSessionKey: fun("0x944423f9", "publishWithSessionKey(address,address,string,uint64,uint96,string,string,uint256,bytes)", {"owner": p.address, "sessionKey": p.address, "_arweaveId": p.string, "_categoryId": p.uint64, "_royaltyBps": p.uint96, "_originalAuthor": p.string, "_title": p.string, "deadline": p.uint256, "signature": p.bytes}, p.uint256),
