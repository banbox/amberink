...
export const events = {
    ...
    ArticlePublished: event("0xaaafc31e67cde120dc74c06c04de8bfcf7d24d418d8568d4e2ad30dc8fca1c9b", "ArticlePublished(uint256,address,uint16,string,string,string,string,uint96,uint16,uint8,uint8)", {"articleId": indexed(p.uint256), "author": indexed(p.address), "categoryId": indexed(p.uint16), "arweaveId": p.string, "originalAuthor": p.string, "title": p.string, "summary": p.string, "collectPrice": p.uint96, "maxCollectSupply": p.uint16, "originality": p.uint8, "visibility": p.uint8}),
...
export const functions = {
    ...
    articles: viewFun("0xedcfafe6", "articles(uint256)", {"_0": p.uint256}, {"author": p.address, "timestamp": p.uint64, "categoryId": p.uint16, "originality": p.uint8, "visibility": p.uint8, "collectPrice": p.uint96, "maxCollectSupply": p.uint16, "collectCount": p.uint16, "arweaveHash": p.string}),
    ...
    getArticleByArweaveId: viewFun("0x989cfb57", "getArticleByArweaveId(string)", {"_arweaveId": p.string}, p.struct({"author": p.address, "timestamp": p.uint64, "categoryId": p.uint16, "originality": p.uint8, "visibility": p.uint8, "collectPrice": p.uint96, "maxCollectSupply": p.uint16, "collectCount": p.uint16, "arweaveHash": p.string})),
    ...
    publish: fun("0x2801f5df", "publish((string,uint16,uint96,string,string,string,address,uint96,uint16,uint8,uint8))", {"params": p.struct({"arweaveId": p.string, "categoryId": p.uint16, "royaltyBps": p.uint96, "originalAuthor": p.string, "title": p.string, "summary": p.string, "trueAuthor": p.address, "collectPrice": p.uint96, "maxCollectSupply": p.uint16, "originality": p.uint8, "visibility": p.uint8})}, p.uint256),
    publishWithSessionKey: fun("0xca967c51", "publishWithSessionKey(address,address,(string,uint16,uint96,string,string,string,address,uint96,uint16,uint8,uint8),uint256,bytes)", {"owner": p.address, "sessionKey": p.address, "params": p.struct({"arweaveId": p.string, "categoryId": p.uint16, "royaltyBps": p.uint96, "originalAuthor": p.string, "title": p.string, "summary": p.string, "trueAuthor": p.address, "collectPrice": p.uint96, "maxCollectSupply": p.uint16, "originality": p.uint8, "visibility": p.uint8}), "deadline": p.uint256, "signature": p.bytes}, p.uint256),
