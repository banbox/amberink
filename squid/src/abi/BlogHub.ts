...
export const events = {
    ...
    ArticlePublished: event("0x8c0eba9177e26954a6456c3131a11edebe1f0d2a7b8d84ce847aaafe5859bdfd", "ArticlePublished(uint256,address,uint256,string,string,string,string,uint256,uint256,uint8)", {"articleId": indexed(p.uint256), "author": indexed(p.address), "categoryId": indexed(p.uint256), "arweaveId": p.string, "originalAuthor": p.string, "title": p.string, "summary": p.string, "collectPrice": p.uint256, "maxCollectSupply": p.uint256, "originality": p.uint8}),
